...
WebUI.callTestCase(findTestCase('Common Test Cases/Login Level Arrow for the Test Case All references to this Test Case are also updated'), [('Username') : 'John Doe', ('Password') : 'ThisIsNotAPassword'], FailureHandling.STOP_ON_FAILURE)
